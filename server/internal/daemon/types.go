...
// ChatAttachment is a file attached to a chat message. The agent fetches
// the actual file via `multica attachment download <id>`.
...
type Task struct {
	...
	ChatAttachments         []ChatAttachment `json:"chat_attachments,omitempty"`         // files attached to the latest user message
